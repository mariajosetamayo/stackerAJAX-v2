...
/***/ function(module, exports, __webpack_require__) {
	...
	var showQuestion = function showQuestion(question) {
		...
		asker.html('<p>Name: <a target="_blank" ' + 'href=https://stackoverflow.com/users/' + question.owner.user_id + ' >' + question.owner.display_name + '</a></p>' + '<p>Reputation: ' + question.owner.reputation + '</p>');
	...
	var getUnanswered = function getUnanswered(tags) {
	...
	var getInspiration = function getInspiration(tags) {
		//<--* the parameters we need to pass in our request to StackOverflow's API *-->
		var request = {
			tagged: tags,
			site: 'stackoverflow',
...
/***/ }
/******/ ]);
//# sourceMappingURL=stackerajax.1.0.0.js.map